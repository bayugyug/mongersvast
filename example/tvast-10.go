...
func main() {
	...
	inAd := mvast.InLineAd(
		...
		&mvast.AdSystem{
			Value: "VAST Inline Simple With Ad Verification",
		},
		&mvast.AdTitle{
			Value: "iabtechlab video ad",
		},
		&mvast.Description{
			Value: "Ad remarks here",
		},
		&mvast.VASTError{
	...
	//INJECT additional vast element (AdVerifications)
	inAd.Ad[0].InLine.AdVerifications = &mvast.AdVerifications{
		Verification: []*mvast.Verification{
			{
				JavaScriptResource: &mvast.JavaScriptResource{
					Value: "https://verificationcompany1.com/verification_script1.js",
				},
			},
			{
				JavaScriptResource: &mvast.JavaScriptResource{
					Value: "https://verificationcompany.com/untrusted.js",
				},
			},
		},
	}
	...
	inAd.Ad[0].InLine.Creatives.Creative[0].Linear.Duration = inAd.VideoDuration(50)
